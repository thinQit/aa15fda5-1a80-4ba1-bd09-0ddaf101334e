...
export default function CTAVortex({
  ...
  description = "Seats are limited during peak dinner hours. Book now for chef specials, wine pairings, and a warm, unforgettable evening.",
  ctaLabel = "Book Now",
  ctaHref = "#contact",
  secondaryCtaLabel = "Call Reservations",
  secondaryCtaHref = "tel:+12125550188",
