...
export default function HeroAurora({
  badge = "Fine Dining • Seasonal Menu • Curated Wines",
  headline = "An Intimate Culinary Journey in the Heart of the City",
  subheadline = "Experience elegant evenings with wood-fired specialties, handcrafted desserts, and hospitality designed for memorable moments.",
